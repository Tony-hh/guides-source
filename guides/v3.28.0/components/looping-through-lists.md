...
[`{{#each}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/each?anchor=each)
  ...
  <div class="cta-note">
    <div class="cta-note-body">
      ...
      <div class="cta-note-message">
        ...
        <p>
        We can use the <a href="https://api.emberjs.com/ember/3.28.0/functions/@ember%2Ftemplate/htmlSafe">htmlSafe</a>
...
[`EmberArray`](https://api.emberjs.com/ember/3.28.0/classes/EmberArray).
...
The [`{{#each}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/each?anchor=each)
...
the [`{{#each-in}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/each-in?anchor=each-in)
helper to do this:
...
tools, and use the [`{{#each}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/each?anchor=each)
helper instead.
