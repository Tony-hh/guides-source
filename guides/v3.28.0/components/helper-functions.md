...
For the full list of available helpers, you can check the [template helpers API documentation](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/).

### The `get` helper

The [`{{get}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/get?anchor=get)
...
[`{{concat}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/concat?anchor=concat)
...
block helper.
The [`{{let}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/let?anchor=let)
...
Using the [`{{array}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/array?anchor=array) helper,
...
Using the [`{{hash}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/hash?anchor=hash)
...
Using the [`{{in-element}}`](https://api.emberjs.com/ember/3.28.0/classes/Ember.Templates.helpers/methods/in-element?anchor=in-element) helper, you can render content into a DOM element that is in a _different_ part of the page. For instance, we might want
