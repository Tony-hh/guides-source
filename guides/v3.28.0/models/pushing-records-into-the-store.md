...
To push a record into the store, call the store's [`push()`](https://api.emberjs.com/ember-data/3.28.0/classes/Store/methods/push?anchor=push) method.
...
[`store.pushPayload()`](https://api.emberjs.com/ember-data/3.28.0/classes/Store/methods/pushPayload?anchor=pushPayload) method.
