...
resolved. The values passed to the [`setupController()`](https://api.emberjs.com/ember/3.28.0/classes/Route/methods/setupController?anchor=setupController) hook for each route
